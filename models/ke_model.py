...
from models.score_funcs import TransEScore, RotatEScore, DistMultScore, ComplExScore, QuatEScore, OTEScore,PairREScore
...
class KGEModel(nn.Layer):
    ...
    def _init_score_function(self, model_name, args):
        ...
        elif model_name == 'pairre9':
            score_func = PairREScore(args.gamma)  #改写函数
        else:
